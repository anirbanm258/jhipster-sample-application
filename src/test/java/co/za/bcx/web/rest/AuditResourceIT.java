...
import co.za.bcx.config.audit.AuditEventConverter;
import co.za.bcx.domain.PersistentAuditEvent;
import co.za.bcx.repository.PersistenceAuditEventRepository;
import co.za.bcx.security.AuthoritiesConstants;
import co.za.bcx.service.AuditEventService;
